    ...
    <div className="fade-in">
      ...
      {!showForm ? (
        ...
        <div className="bg-white p-8 rounded-xl shadow-sm max-w-3xl fade-in">
          ...
          {activeTab === 'info' && (
            <div className="space-y-4 fade-in">
              <div>
                ...
                <input type="text" value={formData.name || ''} placeholder="Nombre del producto"
              ...
              <div>
                ...
                <textarea value={formData.description || ''} placeholder="Describe el producto..."
              ...
              <div className="grid grid-cols-2 gap-4">
                <div>
                  ...
                  <input type="number" value={formData.price || ''} placeholder="Ej: 150000" min="0"
              ...
              <div>
                ...
                <input type="text" value={formData.category || ''} placeholder="Ej: Básculas Digitales"
              ...
              <div>
                <label className="block text-xs font-bold mb-1 text-gray-500 uppercase tracking-wider">URL imagen</label>
                ...
                <div className="mt-2 p-3 bg-blue-50 rounded-lg border border-blue-100">
                  <p className="text-xs text-blue-700 font-bold mb-1">💡 Cómo subir tu foto:</p>
          ...
          {activeTab === 'features' && (
            <div className="fade-in">
              <p className="text-sm text-gray-500 mb-4">Especificaciones técnicas del producto</p>
              {(formData.features || []).length === 0 && (
                <div className="text-center py-6 text-gray-300 bg-gray-50 rounded-xl mb-4 text-sm">Sin características aún</div>
              )}
              <div className="space-y-2 mb-4">
                {(formData.features || []).map((f, i) => (
                  <div key={i} className="flex gap-2 items-center bg-gray-50 p-2 rounded-lg">
                    ...
                    <button onClick={() => removeFeature(i)} className="text-red-400 hover:text-red-600 p-1 rounded-lg transition"><X size={16} /></button>
                  </div>
                ))}
              </div>
              <div className="flex gap-2 bg-orange-50 p-3 rounded-xl border border-dashed border-orange-300">
                <input value={newFeatureKey} onChange={(e) => setNewFeatureKey(e.target.value)}
                  ...
                  className="flex-1 px-3 py-2 border border-gray-200 rounded-lg text-sm focus:ring-2 focus:ring-orange-400 outline-none" placeholder="Ej: Capacidad" />
                <input value={newFeatureValue} onChange={(e) => setNewFeatureValue(e.target.value)}
                  onKeyDown={(e) => e.key === 'Enter' && addFeature()}
                  className="flex-1 px-3 py-2 border border-gray-200 rounded-lg text-sm focus:ring-2 focus:ring-orange-400 outline-none" placeholder="Ej: 5kg" />
            ...
            <div className="fade-in space-y-4">
              <label className="flex items-center gap-3 cursor-pointer p-4 border-2 border-gray-200 rounded-xl hover:bg-orange-50 hover:border-orange-300 transition">
                ...
                <div>
                  ...
                  <p className="text-xs text-gray-500">Aparecerá en Ofertas Especiales con badge animado</p>
                </div>
              </label>
              {formData.isOffer && (
                <div className="grid grid-cols-2 gap-4 fade-in">
                  <div>
                    ...
                    <input type="number" value={formData.originalPrice || ''} min="0"
                      ...
                      className="w-full px-4 py-3 border border-gray-200 rounded-xl focus:ring-2 focus:ring-orange-400 outline-none text-sm" placeholder="Ej: 200000" />
